...
export const researchTopics = [
  ...
  {
    id: 'galaxy-environment',
    title: 'Galaxy-environment connection',
    description:
    ...
    papers: [
      {
        title: 'Newton et al., 2025, MNRAS, 542(2), 591-607',
        venue: 'MNRAS',
        year: 2025,
        date: '2025-09-11',
        summary:
        ...
        links: [
          {
            label: 'Journal',
            href: 'https://doi.org/10.1093/mnras/staf1226',
            type: 'journal'
          },
          {
            label: 'arXiv',
            href: 'https://arxiv.org/abs/2409.04516',
            type: 'arxiv'
          },
          {
            label: 'ADS',
            href: 'https://ui.adsabs.harvard.edu/abs/2025MNRAS.542..591N/abstract',
            type: 'ads'
          },
          {
            label: 'Zenodo',
            href: 'https://doi.org/10.5281/zenodo.16614763',
            type: 'zenodo'
          },
          {
            label: 'GitHub',
            href: 'https://github.com/Musical-Neutron/gc-gmics',
            type: 'github'
          },
        ],
      },
      {
        title: 'Hunde, Newton et al., 2025, A&A, 700, A65',
        venue: 'A&A',
        year: 2025,
        date: '2025-08-01',
        summary:
        ...
        links: [
          {
            label: 'Journal',
            href: 'https://doi.org/10.1051/0004-6361/202452246',
            type: 'journal'
          },
          {
            label: 'arXiv',
            href: 'https://arxiv.org/abs/2409.09226',
            type: 'arxiv'
          },
          {
            label: 'ADS',
            href: 'https://ui.adsabs.harvard.edu/abs/2025A%26A...700A..65H/abstract',
            type: 'ads'
          },
        ],
      },
  ...
  // Warm dark matter
  {
    ...
    papers: [
      {
        title: 'Newton et al., 2025, MNRAS, 541(4), 3713-3727',
        venue: 'MNRAS',
        year: 2025,
        date: '2025-08-21',
        summary:
        ...
        links: [
          { label: 'Journal', href: 'https://doi.org/10.1093/mnras/staf1223', type: 'journal' },
          { label: 'arXiv', href: 'https://arxiv.org/abs/2408.16042', type: 'arxiv' },
          { label: 'ADS', href: 'https://ui.adsabs.harvard.edu/abs/2025MNRAS.541.3713N/abstract', type: 'ads' },
        ],
      },
      {
        title: 'Newton et al., 2021, JCAP, 2021(08), 62',
        venue: 'JCAP',
        year: 2021,
        date: '2021-08-01',
        summary:
        ...
        links: [
          { label: 'Journal', href: 'http://doi.org/10.1088/1475-7516/2021/08/062', type: 'journal' },
          { label: 'arXiv', href: 'https://arxiv.org/abs/2011.08865', type: 'arxiv' },
          { label: 'ADS', href: 'https://ui.adsabs.harvard.edu/abs/2020arXiv201108865N/abstract', type: 'ads' },
        ],
      },
      {
        title: 'Enzi, Murgia, Newton et al., 2021, MNRAS, 506(4), 5848-5862',
        venue: 'MNRAS',
        year: 2021,
        date: '2021-10-01',
        summary:
        ...
        links: [
          { label: 'Journal', href: 'http://doi.org/10.1093/mnras/stab1960', type: 'journal' },
          { label: 'arXiv', href: 'https://arxiv.org/abs/2010.13802', type: 'arxiv' },
          { label: 'ADS', href: 'https://ui.adsabs.harvard.edu/abs/2020arXiv201013802E/abstract', type: 'ads' },
        ],
      },
    ],
    },
  ...
  // Local Group
  {
    ...
    papers: [
      {
        title: 'Osipova et al., 2023, PDU, 42, 101328',
        ...
        links: [
          {
            label: 'Journal',
            href: 'https://www.sciencedirect.com/science/article/pii/S2212686423001620',
            type: 'journal'
          },
          {
            label: 'arXiv',
            href: 'https://arxiv.org/abs/2209.07234',
            type: 'arxiv'
          },
          {
            label: 'ADS',
            href: 'https://ui.adsabs.harvard.edu/abs/2023PDU....4201328O/abstract',
            type: 'ads'
          },
        ],
      },
      {
        title: 'Newton et al., 2022, MNRAS, 514(3), 3612-3625',
        venue: 'MNRAS',
        year: 2022,
        date: '2022-08-11',
        summary:
        ...
        links: [
          {
            label: 'Journal',
            href: 'http://doi.org/10.1093/mnras/stac1316',
            type: 'journal'
          },
          {
            label: 'arXiv',
            href: 'https://arxiv.org/abs/2104.11242',
            type: 'arxiv'
          },
          {
            label: 'ADS',
            href: 'https://ui.adsabs.harvard.edu/abs/2021arXiv210411242N/abstract',
            type: 'ads'
          },
          {
            label: 'Zenodo',
            href: 'https://doi.org/10.5281/zenodo.4708339',
            type: 'zenodo'
          },
        ],
      },
{
        title: 'Newton et al., 2023, ApJL, 946(2), L37',
        venue: 'ApJL',
        year: 2023,
        date: '2023-03-31',
        summary:
        ...
        links: [
          {
            label: 'Journal',
            href: 'http://doi.org/10.3847/2041-8213/acc2bb',
            type: 'journal'
          },
          {
            label: 'arXiv',
            href: 'https://arxiv.org/abs/2212.05066',
            type: 'arxiv'
          },
          {
            label: 'ADS',
            href: 'https://ui.adsabs.harvard.edu/abs/2022arXiv221205066N/abstract',
            type: 'ads'
          },
          {
            label: 'Zenodo',
            href: 'https://doi.org/10.5281/zenodo.7729995',
            type: 'zenodo'
          },
          {
            label: 'GitHub',
            href: 'https://github.com/Musical-Neutron/lg_field_udgs',
            type: 'github'
          },
        ],
      },
  ...
  // Satellite galaxies
  {
    ...
    papers: [
      {
        title: 'Newton et al., 2018, MNRAS, 479(3), 2853-2870',
        venue: 'MNRAS',
        year: 2018,
        date: '2018-09-21',
        summary:
        ...
        links: [
          { label: 'Journal', href: 'https://academic.oup.com/mnras/article-abstract/479/3/2853/4990653', type: 'journal' },
          { label: 'arXiv', href: 'https://arxiv.org/abs/1708.04247', type: 'arxiv' },
          { label: 'ADS', href: 'https://ui.adsabs.harvard.edu/abs/2018MNRAS.479.2853N/abstract', type: 'ads' },
          { label: 'Zenodo', href: 'https://doi.org/10.5281/zenodo.1205622', type: 'zenodo' },
        ],
      },
      {
        title: 'Lovell et al., 2021, MNRAS, 507(4), 4826-4839',
        venue: 'MNRAS',
        year: 2021,
        date: '2018-11-11',
        summary:
        ...
        links: [
          { label: 'Journal', href: 'https://doi.org/10.1093/mnras/stab2452', type: 'journal' },
          { label: 'arXiv', href: 'https://arxiv.org/abs/2104.03322', type: 'arxiv' },
          { label: 'ADS', href: 'https://ui.adsabs.harvard.edu/abs/2021MNRAS.507.4826L/abstract', type: 'ads' },
        ],
      },
    ],
  },
  ...
  // // 4. Undiscovered ultra-diffuse galaxies in the Local Group
  // {
  //   id: 'udgs-local-group',
  //   title: 'Undiscovered ultra-diffuse galaxies in the Local Group',
  //   description:
  //     "Ultra-diffuse galaxies (UDGs) resemble the brightest Milky Way satellites in luminosity but are many times larger, making them extremely diffuse and hard to observe. A substantial fraction of galaxies may be ultra-diffuse, making them important tests of cosmological models. This work shows that there is a population of UDGs in the Local Group awaiting discovery, some of which may already reside in Sloan Digital Sky Survey and Dark Energy Survey data.",
  //   papers: [
  //     {
  //       title: 'Newton et al., 2023, ApJL, 946(2), L37',
  //       venue: 'ApJL',
